<x-dashboardLayout>
    ...
    <div class="p-4">
        ...
        <div class="bg-white h-[80vh] p-5">
            ...
            <form id="form" action="{{ route('add.Forum') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="flex ">
                    <div class="w-full col-10 pr-20 mb-10">
                        <div >
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900">Title</label>
                            <input type="text" name="name" id="name" value="" class="bg-gray-50 border border-black text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Work forum..." required="">
                        </div>
