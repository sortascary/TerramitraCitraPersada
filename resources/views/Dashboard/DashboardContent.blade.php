    ...
    <div class="p-4">
        ...
        <div class="flex overflow-x-scroll my-5 justify-evenly">
            ...
            <div class="bg-white flex col-3 m-2 p-3 drop-shadow gap-2 rounded-[5px] items-center">
                ...
                <div class="font-semibold">
                    <p class="m-0 text-xl">Total Views</p>
                    <p class="m-0 text-xl">{{$viewCount}}</p>
                </div>
            </div>
            <div class="bg-white flex col-3 m-2 p-3 drop-shadow gap-2 rounded-[5px] items-center">
                <div class="h-full p-3 aspect-square bg-[#1D546D] items-center justify-center flex rounded-[20px]">
                    ...
                    <div class="flex items-center">
                        <div class="bg-stone-200" style="width: 100px; height: 100px;">
                            @if ($content->contentattachments->first())
                                <img src="{{ asset($content->contentattachments->first()->file) }}" alt="Blog images" style="width: 100px; height: 100px; object-fit: cover;">  
